<?php
  ...
  define("THUMBNAILURL", "http://localhost/homeland/admin-panel/properties-admins/thumbnails");  
  define("GALLERYURL", "http://localhost/homeland/admin-panel/properties-admins/images");  
  
  //for the css and js part to be included into link/href/js since the register page is not in root folder


  require dirname (dirname(__FILE__)) . "/config/config.php";

  // connection to the database with table name props
  $categories =$conn->query("SELECT * FROM categories");//order the name in descending order
  $categories->execute();
