...
if(!isset($_SESSION['username'])){
  ...
  props.price AS price, props.bed AS bed, props.bath AS bath, props.sq_ft AS sq_ft, 
  props.type AS type FROM `props` JOIN requests ON props.id = requests.prop_id
...
<div class="site-wrap">
    ...
    <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url(<?php echo APPURL; ?>/images/bg_image.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
    <div class="container">
    ...
    <div class="container">
      ...
      <div class="row mb-5">
        <?php if(count($props) > 0) : ?>
          ...
          <?php endforeach; ?>
        <?php else : ?>
          <div class="bg-success text-white mt-5">You did not have any property requests yet</div>
        <?php endif; ?>
      </div>
