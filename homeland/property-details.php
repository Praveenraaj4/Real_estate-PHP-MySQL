...
<?php
  ...
  //display details for prop
    $single = $conn->query("SELECT * FROM props WHERE id='$id'"); // selecting type from props table
  ...
  $images =$conn->query("SELECT * FROM related_images WHERE prop_id = '$id'"); // the propd_id connects to the id of the prop table
  $images->execute();
      ...
      <div class="container">
        <div class="row">
              ...
              <div class="row mb-5">
                ...
                <div class="col-md-6">
                  ...
                  <li>
                    ...
                    <span class="property-specs-number"><?php echo $allDetails->bed; ?></span>
          ...
          <div class="col-lg-4">
            ...
            <div class="bg-white widget border rounded">
              ...
              <?php if(isset($_SESSION['user_id'])) : ?>
                  <?php if($check_request->rowCount() > 0) : ?>
                    <p>You already requested this property, cannot send anymore request</p>
                  <?php else : ?>
                  ...
                  <?php endif; ?>
              <?php else : ?>
                <p>log in order to send a request to this property</p>
              <?php endif; ?>
            </div>
            ...
            <div class="bg-white widget border rounded">
              <h3 class="h4 text-black widget-title mb-3 ml-0">Add this to Favourite </h3>
                  <div class="px-3" style="margin-left: -15px;">
                  <?php if(isset($_SESSION['user_id'])) : ?>
                    ...
                    <?php else: ?>
                      <p>log in order save this property to favs</p>
                    <?php endif; ?> 
                  </div>            
            </div>
          ...
          <?php foreach ($allRelatedProps as $allRelatedProp) :?>
            ...
            <div class="col-md-6 col-lg-4 mb-4">
              <div class="property-entry h-100">
                <a href="property-details.php?id=<? echo $allRelatedProp->id; ?>" class="property-thumbnail">
                ...
                <div class="p-4 property-body">
                  ...
                  <ul class="property-specs-wrap mb-3 mb-lg-0">
                    <li>
                      <span class="property-specs">Beds</span>
                      <span class="property-specs-number"><?php echo $allRelatedProp->bed; ?></span>
