...
if(isset($_POST['submit'])){
    ...
    //wildcards mysql used below can use % or _  >> wildcards is the continuation of a word/data fetched 
    $search = $conn->query("SELECT * FROM props WHERE home_type LIKE '%$types%' OR  
    type LIKE '%$offers%' OR location LIKE '%$cities%'");
    $search->execute();//command to use it
        ...
        <div class="row mb-5">
            ...
            <?php foreach($listings as $listing) : ?>
                ...
                <a href="property-details.html" class="property-thumbnail">
                    ...
                    <img src="<?php echo THUMBNAILURL; ?>/<?php echo $listing->image; ?>" alt="Image" class="img-fluid">
                </a>
                <div class="p-4 property-body">
                    ...
                    <li>
                        ...
                        <span class="property-specs-number"><?php echo $listing->bed; ?></span>
            ...
            <?php endforeach; ?>
            <?php else: ?>
              <div class="bg-success text-white">we dont have any record any listing this query for now</div>
            <?php endif; ?>
